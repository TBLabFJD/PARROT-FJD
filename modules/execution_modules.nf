...
process FORMAT2INFO {
	...
	// GT:AD:DP:VAF:SF:GD:DV_GT:DV_DP:DV_VD:DR_GT:DR_DP:DR_VD:GK_GT:GK_DP:GK_VD
		...
		#el comando original es el de paste pero como el comando esta dentro del container de bioinfotools y no lo estoy cargando pues no vaentonces cambio a awk
		awk '{getline line < "new_info.txt"; print \$0 ";" line}' old_info.txt >> ${sample}.vcf_to_annotate.vcf
